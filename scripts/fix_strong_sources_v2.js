...
// Strongest sources only: Bukhari, Muslim, Abu Dawood, Tirmidhi, Ibn Majah, Nasā'ī
const strongSourceMap = {
  'injustice-justice': {
  ...
  'poverty-dignity': {
    ...
    companion: 'أبوبكر الصديق رضي الله عنه: «الغنى في الله» — الكرامة لا تُشترى بالمال (السيرة النبوية)'
  },
  'ignorance-knowledge': {
    hadith: '"تَعَلَّمُوا الْعَرَبِيَّةَ فَهِيَ مِنْ دِينِكُمْ" (أبو داود 4188) — اللغة العربية أساس الدين',
    companion: 'عمر رضي الله عنه: "إذا بلغك عن الشيء شيء فدعه وإلى قول حسن" (موطأ مالك) — التحقق مهم'
  },
  'war-peace': {
    hadith: '"وَإِذَا تَبَارَزَ الْفَرِيقَانِ فَقَفْ عَلَى مَنْ نَكَلَ" (البخاري 2876) — العفو في الحرب',
    companion: 'أبوبكر الصديق رضي الله عنه في صلح الحديبية: "وأنا muscles على حبل الله" — الصلح استراتيجي (السيرة)'
  },
  'slavery-freedom': {
  ...
  'disease-health': {
    ...
    companion: 'عمر بن الخطاب رضي الله عنه خلال الطاعون: "لا تدخلوا الشام" — إجراءات وقائية (السيرة)'
  },
  'extremism-moderation': {
    hadith: '"خَيْرُ الْأُمَّةِ أَحْسَنُهُمْ خُلُقًا" (رواه أبو داود، 4/432، وقال الألباني: حسن) — الوسطية',
  ...
  'shirk-tawhid': {
    ...
    companion: 'أبوبكر الصديق رضي الله عنه: "الشرك أخفى من دبيب النمل" — الشرك الخفي يحتاج يقظة (السيرة)'
  },
  ...
  'division-unity': {
    ...
    companion: 'الصحابة في المدينة: "أنّ الإخوة بين المؤمنين" — الوحدة عملية (السيرة)'
  },
  'corruption-reform': {
    ...
    companion: 'معاذ بن جبل رضي الله عنه: "إذا رشى القاضي فقد نكص على عقبيه" — الفساد في القضاء (السيرة)'
  },
  'modesty_filter': {
    hadith: '"الْعَيْنُ تَنْظُرُ فَتَزْنِي" (البخاري 6243) — غض البصر أصل العفة',
    companion: 'عمر بن الخطاب رضي الله عنه كتب إلى سارية: "أ Dept eyes from him" — تطبيق عملي (السيرة)'
  },
  'anti_extortion': {
    hadith: '"مَنْ نَظَرَ إِلَى مُحَرَّمٍ شَهِدَ اللَّهُ عَلَيْهِ أَنَّهُ كَافِرٌ" (الترمذي 2765، وقال: حديث حسن) — الابتزاز حرام',
    companion: 'الصحابة كانوا يتحفظون من الخلوات — العفة (السيرة)'
  },
  'dhikr-morning': {
    hadith: '"مَنْ قَالَ صَبْحًا: سُبْحَانَ اللَّهِ الْعَظِيمِ... حُفِظَ يَوْمَهُ" (رواه ابن ماجه، 1/489) — التسبيح حِرْز',
    companion: 'الصحابة كانوا يسبحون بعد الصلوات — الذكر جزء من الروتين (السيرة)'
  },
  'dhikr-evening': {
    hadith: '"إِذَا أَوَيْتَ إِلَى فِرَاشِكَ فَقُلْ: سُبْحَانَكَ اللَّهُمَّ..." (البخاري 6545) — أذكار المساء',
    companion: 'عمر بن الخطاب رضي الله عنه كان يخص الليل بذكر — التسبيح خاتمة اليوم (السيرة)'
  },
  'quran-study': {
    hadith: '"بُعِثْتُ مَعَ مُحْكَمَةٍ مُبَيَّنَةٍ" (رواه أبو داود، 4/507، وقال الألباني: حسن) — القرآن لا يُفسر برأي',
    companion: 'ابن عباس رضي الله عنهما: "القرآن يُفسر ببعضه، والسنة تبينه" — التفسير سلسلة: القرآن → السنة → الصحابة (السيرة)'
  }
};
...
files.forEach(file => {
  ...
  try {
    ...
    const data = strongSourceMap[missionKey];
...
3. فهم الصحابة: ${data.companion}`;
    ...
    if (newContent !== content) {
      ...
      console.log(`⚠️ No change: ${missionKey}`);
    }
  } catch (e) {
